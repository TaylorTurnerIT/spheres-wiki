...
sectionDefinitions:
  - label: "Talents"
    categories:
      - label: "Study Talents"
        tiers: ["basic"]
        excludeTags: ["complication", "theory"]
      - label: "Complication Talents"
        tiers: ["basic"]
        tags: ["complication"]
      - label: "Theory Talents"
        tiers: ["basic"]
        tags: ["theory"]
...
Operatives of the Study sphere are dedicated researchers and theorists, capable of analyzing situations and formulating effective strategies.

**Associated Skill:** Knowledge (any one).

You gain the following benefits when you gain the Study sphere:

You gain 5 ranks in the chosen Knowledge skill, plus 5 ranks per additional talent spent in the Study sphere (maximum ranks equal to your Hit Dice). If you already have ranks in the associated skill you may immediately retrain them.

**Skill Leverage:** You unlock skill leverage with all Knowledge skills.
