...
You can distract a creature with your words. The creature must be able to understand your words and be within 60 feet. You can choose either to fascinate the target or to distract the target from an ongoing effect you choose; you can only distract them from an auditory or visual mind-affecting effect that allowed a saving throw or required a skill check.
...
To distract the target from a mind-affecting effect, you must succeed at a skill check using your associated skill against the effect’s skill check result or save DC. If you succeed against a skill check, the effect ends. If you succeed against a save DC, the target attempts a new saving throw against the mind-affecting effect at the end of your turn each round with a +4 bonus, ending the effect on a success.
