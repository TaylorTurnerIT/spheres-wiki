  ...
  - label: "Talents"
    categories:
      - label: "Performance Talents"
        tiers: ["basic"]
        excludeTags: ["act", "dance", "instrumental", "lyric"]
      - label: "Act Talents"
        tiers: ["basic"]
        tags: ["act"]
      - label: "Dance Talents"
        tiers: ["basic"]
        tags: ["dance"]
      - label: "Instrumental and Lyric Talents"
        tiers: ["basic"]
        tags: ["instrumental", "lyric"]
      - label: "Exceptional Talents"
        tiers: ["advanced"]
      - label: "Performance Sphere Feats"
        tiers: ["feat"]
---

Operatives of the Performance sphere are creators of various creative endeavors, be it brilliant ballads, complex choreography, or musical melodies; a performer's ability to draw the eye and instill hope and emotion into those around them is astounding.
