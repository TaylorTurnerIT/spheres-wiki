...
Whenever a creature benefitting from this quip attempts an initiative check, they can move up to 10 feet +5 feet per 5 ranks in the associated skill as an immediate action (to a maximum distance equal to their speed). If the creature can perceive a threat, this movement must be away from that threat or otherwise towards safety (subject to GM discretion).