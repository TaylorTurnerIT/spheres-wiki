...
++++ Adrenaline Rush [Tension]  [LG]

When the striker uses speed step, she may spend an additional point of tension to not provoke attacks of opportunity for moving.
...
++++ Area Strike [Tension]  [LG]

The striker may spend 2 tension to have the next natural attack she makes target all creatures in a 15-foot cone or a 25-foot line. For each additional tension you spend to activate this adaptation, the striker may increase the cone's length by 5 feet or increase the line's length by 10 feet. Regardless of how many creatures are hit by this attack, she cannot apply the effects of an attack action to more than one target (as if she were making an attack with a scatter weapon).
...
++++ Avenging Burst [Tension] [LG]

When the striker is hit by a melee attack, she may spend 1 point of tension as an immediate action to vent energy on the attacker. The attacker takes 1d4 points of fire and electricity damage per 2 striker levels (Reflex save half, DC 10 + 1/2 the striker's level + her practitioner modifier). The striker may spend 1 additional point of tension to increase the damage dice from 1d4 to 1d6, or 2 additional points of tension to increase them from 1d4 to 1d8.

++++ Biotic Invigoration [Tension] [LG]

When the striker would receive healing, she may spend 1 tension to increase that healing by her striker level. By spending 2 points of tension as a swift action, the striker may heal herself for 1d6 points of damage per 2 striker levels, to a maximum of 1/2 her maximum hp.
...
++++ Critical Endurance [Tension] [LG]

If the striker is subject to a critical hit or instance of precision damage, she may spend 1 tension to gain a 25% chance to negate this additional damage as per the fortification armor special ability. For every additional point of tension spent, this chance increases by 25%, to a maximum of 100%.
...
++++ Defensive Sequestration [LG]

When the striker takes the total defense action, she gains 3 points of tension.

++++ Dig In [Tension] [LG]

When the striker would be forcibly moved or fall prone, she may spend 1 point of tension to not fall prone and reduce the movement by 5 feet.
...
++++ Outburst [Tension] (requires Striker 8) [LG]

The striker may spend 3 points of tension as a standard action to make an attack with an unarmed strike against each enemy in her reach.

++++ Phasic Blitz (requires adrenaline rush) (Su) [LG]
...
++++ Resistant Transformation [Tension] [LG]

The striker may spend 2 points of tension to gain resistance to one energy type of her choice for a number of rounds equal to her practitioner modifier. This resistance is equal to her striker level.

++++ Skill Adaptation [LG]

The striker gains additional skill points equal to her striker level and selects two additional skills as class skills. This striker art may be selected multiple times.

++++ Speed Pummeling (Requires Striker 5)
The striker can use her rapid pummeling tension technique as a free action.

++++ Spell Bending [Tension] [LG]

When a willing ally within close range of the striker casts a spell, the striker can spend 3 tension as an immediate action to absorb and redirect the spell's energy. The striker chooses the spell's targets, measures the spell's range from her space, and makes any attack rolls for the spell as if she were the caster, though the original spellcaster attempts any caster level checks, rolls any damage, and is responsible for controlling and concentrating on any subsequent effects of the spell. In addition, the striker also applies one of the following three special effects to the spell:

- Increase the spell's saving throw DCs by 2.
- Grant the caster a +3 bonus to overcome spell resistance.
- If the spell deals damage, the striker can replace her unarmed strikes and natural attacks' damage with one damage type dealt by the spell until the end of her next turn.

++++ Spell Blocker [Tension] [LG]

By spending 2 points of tension, the striker may gain spell resistance equal to 11 + her striker level until the start of her next turn.
...
As a standard action, the striker may make a melee touch attack against a creature. The target must attempt a Fortitude save (DC 10 + 1/2 the striker's level + her practitioner modifier) or become sickened for a number of rounds equal to the striker's level. On a successful touch attack, the striker gains 1 point of tension, or 3 points of tension if the target fails their saving throw.

++++ Tension Drain, Improved [LG]

When the striker uses tension drain, the striker gains 1 additional point of tension on a successful attack. A target who fails their saving throw is also nauseated for 1 round.
...
++ ##993300|Improved Uncanny Dodge (Ex)##
...
++ ##993300|Black Powder Brawler##
Black Powder Brawlers are experts with the use of firearms, and integrate them into their combat style instead of relying on their fists.

++ ##993300|Chaos Shifter##
Chaos Shifters use mutagenic formulas to become true monsters on the battlefield.

++ ##00c000|Elemental Fist## [CS]
Elemental fists can use the powers of nature to augment their blows.

++ ##00c000|Evolutionist## [LG]
...
++ ##993300|Shadowed Fist##
Shadowed Fists are stealthy strikers that can learn the arts of the ninja to help them assassinate their foes.

++ ##993300|Skirmishing Scout##
Skirmishing Scouts are darting combatants who are always on the move.

++ ##993300|Strong Style Grappler##
Strong Style Grapplers focus on grappling foes to quickly and effectively bring them down.

++ ##00c000|Voidrusher## [CS] [DRS]
Voidrushers combine their innate talents with the inhuman might of a powerful outsider bound to their flesh.
---
