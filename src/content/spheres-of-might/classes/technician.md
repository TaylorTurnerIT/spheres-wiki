...
---
++ ##993300|List of Technical Insights##
...
If you have electric insight, you may create any 'robot' constructs from official bestiaries, as well any construct so long as you give it the robot subtype.

If you have mechanical insight, you may create any 'clockwork' constructs from official bestiaries, as well any construct so long as you give it the clockwork subtype.

If you have steampowered insight, you may create any 'steam' constructs from official bestiaries, as well any construct so long as you give it the steampowered subtype.
...
Mechanical enhancements are hardwired into your brain. Improvement benefits from an exocortex cannot be applied to any character other than the technician.
...
++++ Combat Aptitude
The technician gains a combat feat of his choice as a bonus feat, chosen when this invention is created. This improvement may be selected once for every 6 technician levels the technician possesses, each time selecting a new combat feat.

++++ Combat Tracking
As a move action, the technician can designate a foe for the exocortex to track. As long as that target is in sight, the exocortex feeds the technician telemetry, vulnerabilities, and combat tactics, allowing the technician to make attacks against that target and use combat sphere abilities on the target as if his base attack bonus from the technician levels were equal to his technician level. Designating another target causes the technician to immediately lose this bonus against the previous target.

This ability counts as the slayer's studied target ability for the purpose of feats and for meeting prerequisites.

++++ Echolocators (Requires Electrical Insight)
...
++++ Memory Module (Requires Chemical Insight)
The technician gains Skill Focus as a bonus feat. By spending martial focus, the technician may reduce the time needed to use the skill selected with Skill Focus. If the skill use would normally take 2 rounds or longer, the recipient of the aid finishes in half the time. If the skill use would normally take 1 round or less, reduce the time it takes by one step along this list: 1 round, 1 full-round action, 1 standard action, 1 move action, 1 swift action, 1 immediate action (taken at the end of the turn).

++++ Multitargeting (Requires Combat Tracking)
The technician may use combat tracking on up to three creatures at a time. This improvement may be selected a second time, in which case the technician may use combat tracking on any number of targets.

++++ Sonar Pulse (Requires Echolocators)
...
++++ Armor Improvements
The improved backpack can gain the air bladder or parachute improvements as if it were a suit of improved armor.
...
++++ Transmitter (Requires Electric Insight)
...
The boots gain a swimming mode. While in swimming mode, the wearer's land speed is reduced by half, but they gain a bonus to Swim checks equal to the technician's level.
...
++ ##993300|Improved Firearm##
Anyone other than the technician himself suffers a -2 penalty to attack rolls per improvement when using an improved firearm.
...
++ ##993300|Improved Shield##
Anyone other than the technician himself suffers a -3 increase to the shield's armor check penalty per improvement when using an improved shield. Prerequisites: The shield to be improved.
...
If taken a third time, the bearer may deploy the shield in this manner as a move action instead of a standard action.
...
|---|---|---|---|---|---|---|
| 1 | 1d10 | Medium | Medium | +0 | +0 | 1 |
| 2 | 2d10 | Medium | Medium | +0 | +0 | 1 |
| 3 | 3d10 | Medium | Medium | +1 | +1 | 1 |
| 4 | 4d10 | Medium | Medium | +1 | +1 | 1 |
| 5 | 5d10 | Large | Small | +1 | +1 | 2 |
| 6 | 6d10 | Large | Small | +2 | +2 | 2 |
| 7 | 7d10 | Large | Small | +2 | +2 | 2 |
| 8 | 8d10 | Large | Small | +2 | +2 | 2 |
| 9 | 9d10 | Huge | Tiny | +3 | +3 | 3 |
| 10 | 10d10 | Huge | Tiny | +3 | +3 | 3 |
| 11 | 11d10 | Huge | Tiny | +3 | +3 | 3 |
| 12 | 12d10 | Huge | Tiny | +4 | +4 | 3 |
| 13 | 13d10 | Gargantuan | Diminutive | +4 | +4 | 4 |
| 14 | 14d10 | Gargantuan | Diminutive | +4 | +4 | 4 |
| 15 | 15d10 | Gargantuan | Diminutive | +5 | +5 | 4 |
| 16 | 16d10 | Gargantuan | Diminutive | +5 | +5 | 4 |
| 17 | 17d10 | Colossal | Fine | +5 | +5 | 5 |
| 18 | 18d10 | Colossal | Fine | +6 | +6 | 5 |
...
++++ Aquatic
The invention gains 1 rank in the Swim skill skill for every technician level possessed. If the invention contains the suit or vehicle improvements, it contains enough air to allow its maximum number of occupants to breathe for 8 hours while the vehicle is submerged.
...
---
+ ##993300|Technician Alternate Class Features##
...
The innovator may expend a gadget to create a temporary battery gizmo, which lasts for 10 minutes per technician level. The technician may attach this battery gizmo to a gizmo in their possession as part of expending a gadget. If this battery gizmo's duration expires while being used to power another gizmo's battery use ability, that battery use ability also ends.

A battery gizmo created this way is treated as a gizmo the technician crafted, has a gizmo level equal to the technician's class level, and does not count towards the technician's gizmo limit.

This ability alters gadgets.

---
+ ##993300|Archetypes##

++ -Adamantine Scientist
Adamantine Scientists are exceptionally good at punching their foes with augmented gloves.

++ -Innovator [SUE]
Innovators are Tinker-savvy inventors and able to invent and reinvent to meet challenges.

++ -Mad Scientist
Mad Scientists mix magic and mechanics to create magnificent monstrosities.

++ -Mythbreaker
Mythbreakers know that magic is often less mighty than it seems - and with the right tools, they can be dispelled more effectively.

++ -Rigger
Riggers excel at using the Tech sphere and jury-rigging devices together.

++ -Suit Pilots
Suit pilots have one goal, and one goal only: Creating the best suit of powered armor they can.

---

+ ##993300|Favored Class Bonuses##

**Aasimar:** Increase the benefit of your danger sense class feature by +1/3.

**Created:** Gain +1/8th of a new invention.

**Dwarf:** Increase the range of your trap insight class feature by 1 foot.

**Elf:** For every 4 times this favored class bonus is taken, your inventions count as possessing one fewer improvements when calculating the penalties other creatures suffers when using them.

**Gnome:** Gain +1/8th of a new invention.

**Goblin:** Gain 1/3rd of an additional gadget each day which can only be used as a detonator.

**Halfling:** Add a +1/2 bonus to all Disable Device checks made to pick a lock or disarm or reset a trap.

**Hobgoblin:** When you deal fire, cold, electricity, or acid damage with an invention, your invention ignores 1 point of resistance for that particular element.

**Human:** Gain +1/6th of a technical insight.

**Kobold:** Gain 1/6th of a Trap sphere talent.

**Orc:** Gain +1 energy resistance to one kind of energy (+10 maximum per energy type).

**Tatulani:** Gain +1/6th of a technical insight.

**Tiefling:** Whenever you deal damage to a target within 30 ft. that is either flat-footed, that you are flanking, or that has lost its Dexterity bonus to ac, you deal an additional +1/2 damage to that target.
...
This book contains detailed schematics for creating a specific invention. A creature with the inventions class feature can use these instructions to create an additional invention (that does not count against their normal limit) consisting of a base invention and one associated improvement, with the specific options chosen when this item is created. The creature following this guide must still meet any other prerequisites for creating the invention (including having any relevant insights), and cannot create any other inventions with the same base. For example, if a gadget guide teaches how to create an improved gloves invention with the webbing improvement, a creature following this guide cannot create any other glove inventions. A creature can only create an invention from one gadget guide at a time.
...
This heavy tome is sometimes used as a reference for higher education, particularly in areas with extensive schooling opportunities. Despite being several hundred pages thick, every page is needed to detail the complex interactions of certain chemicals and materials. A creature with the technical insights class feature can study this manual to gain the benefits of one technical insight, chosen when this manual is written. They retain this knowledge for 24 hours, but can read this manual as part of their morning preparations to refresh their knowledge of the insight. Any existing options dependent on this insight (such as an invention using the mechanical insight) fail immediately if a creature loses access to the insight those options depend on. A creature cannot benefit from more than one of these manuals at a time, and studying a different manual erases their knowledge of the previous one.
...
This slender monocle hooks over one ear to stay in place without problems. As a standard action, a creature with the trapfinding ability can peer through this monocle to search for magical auras within 25 feet, and may continue looking for magical auras as long as they concentrate. This functions as the basic divine ability of the Divination sphere.
