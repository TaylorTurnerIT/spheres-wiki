...
level: 1
replaces: ["wise reflexes; other sentinel class features which use the sentinel’s practitioner modifier instead use the darkthrone’s casting ability modifier"]
tags: []
---
