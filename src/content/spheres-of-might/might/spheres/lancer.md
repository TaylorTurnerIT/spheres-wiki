...
sectionDefinitions:
  - label: "Talents"
    categories:
      - label: "Lancer Talents"
        tiers: ["basic"]
        excludeTags: ["impale"]
      - label: "Impale Talents"
        tiers: ["basic"]
        tags: ["impale"]
...
You must make an opposed Strength check against the impaled creature to move, moving up to half of your base speed while the impaled creature is dragged along with you (this movement does not provoke attacks of opportunity).
