...
- **Jinx (word) [curse]:** After a creature within range makes a d20 roll, as an immediate action, you may cause the target to suffer a -1 penalty to that roll. If you spend 1 additional spell point, this penalty increases to -2 - 1 per 10 caster levels. You may use this word after the results of the target's d20 roll are revealed, which may change the results of the d20 roll into a failure. An unwilling target may attempt a Will saving throw to negate this effect.

**Note:** A d20 roll modified by the Felicity (consecration) cannot be modified by other effects (such as the Tug Fate (consecration)) but can be rerolled.
