...
**Author's Note:** This feat can pose uniquely problematic gameplay interactions. At GM discretion: When using this feat to give a mote a condition to activate, if a mote created by the caster is already attached to the target or area with thee same or a similar trigger (GM discretion), the previously created mote is automatically dispelled and does not trigger.

This is to prevent scenarios of delaying multiple beneficial (or harmful) effects from all occurring on the same overlapping trigger.
