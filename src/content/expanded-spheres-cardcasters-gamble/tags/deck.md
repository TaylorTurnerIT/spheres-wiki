...
label: Deck
priority: 260
description: Deck feats specifically deal with the Card Casting drawback.
featCategory: true
color: var(--clr-brand)
---
...
**Addendum:** If you possess the Colored Mana option from Card Casting, you may have any mana point cards created by your companions count as the same color of any mana point cards used to summon your companion. [**Source:** Baron’s Secluded Library]
...
**Addendum:** Rather than at the start of your turn, you may shuffle and redraw your hand at the beginning of each initiative round. This choice is made when you gain this deck manipulation. [**Source:** Baron’s Secluded Library]
...
**Trimmed Deck (requires Singleton modification):** Your minimum deck size is reduced by 4 (to a minimum of 1). This manipulation may be selected multiple times. [**Source:** Baron’s Secluded Library]
...
++++ Handblood’s Advantage [Deck, Drawback]

**Prerequisites:** Card Casting (Bleeding Hand)

**Benefit:** Each card in your deck gains a category from among Physical, Mental, or Spiritual, chosen when you create the card. Whenever you discard a card as part of performing an action, you gain a benefit based on the category of the card discarded.

*Physical:* You gain a +2 luck bonus a single die roll as part of the action that adds your Strength or Constitution modifier
*Mental:* You gain a +2 luck bonus a single die roll as part of the action that adds your Dexterity or Intelligence modifier
*Spiritual:* You gain a +2 luck bonus a single die roll as part of the action that adds your Wisdom or Charisma modifier

++++ Handblood’s Boon [Deck, Drawback]

**Prerequisites:** Card Casting (Bleeding Hand x2), Handblood’s Advantage

**Benefit:** For each card in your deck, choose three feats that you meet the prerequisites for, assigning each of them a category from among Physical, Mental, or Spiritual. You may select the same feat multiple times for a card (for example, you could have a card that has Spell Penetration for both the Mental and Spiritual selections and Spell Focus for the Physical selection).
Whenever you play a card from your hand, you may discard up to three other cards from your hand and spend a standard, move, swift, or immediate action for each card discarded. If you do, any effect created by the played cards benefits from any of the played cards’ feats or magic talents whose categories correspond to the discarded cards. If the chosen feats alter the spell point cost of the effect, you must pay the difference in spell points as normal, though you cannot alter the casting time of the effect. If a feat can be selected multiple times, you may gain its benefits multiple times by discarding multiple cards of its matching category.
For example, you play a card that creates a destructive blast and for which you have chosen the feats Deadly Targeting (Physical), Extra Magic Talent (Extended Range) (Mental), and Extra Magic Talent (Smiting Blast) (Spiritual). You discard two cards, one each of the Mental and Spiritual categories, gaining the benefits of the Extended Range and Smiting Blast talents for the created destructive blast (with Smiting Blast overriding a (blast type) talent normally used in the card).

**Special:** If you have the Enhanced Play feat, you may select metamagic feats as a card’s chosen feats and the casting time of the effect is not increased by the application of any metamagic feats added by discarding cards. You must pay the difference in spell points as normal, though you may do so without them being part of a charged spell if you possess the Charged Spells drawback.

++++ Handblood’s Destiny [Deck, Drawback]

**Prerequisites:** Card Casting (Bleeding Hand)

**Benefits:** You may spend a standard, move, or swift action to discard a card from your hand and increase your initiative count by 3 for the rest of the encounter. This effect is cumulative over multiple uses of this ability.

++++ Handblood’s Guard [Deck, Drawback]

**Prerequisites:** Card Casting (Bleeding Hand)

**Benefits:** Whenever you would be targeted by an attack roll, you may discard a card from your hand to gain a +2 luck bonus to your AC against the attack roll. If you possess the Handblood’s Advantage feat, you may discard a card when you are forced to make a saving throw to gain a +2 bonus to the saving throw based on the type of card discarded.

*Physical:* Fortitude saving throw
*Mental:* Reflex saving throw
*Spiritual:* Will saving throw

**Special:** You may select this feat a second time, in which case you may discard a second card to increase the AC or saving throw bonus from +2 to +4.
...
**Benefits:** You gain several abilities related to interfering with the abilities of other characters with the Card Casting drawback, as per the Control Caster feat. The save DC of these abilities is equal to the sphere DC of one of the ability’s associated spheres.
