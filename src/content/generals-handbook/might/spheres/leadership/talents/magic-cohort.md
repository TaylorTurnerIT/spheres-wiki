...
**Channel (requires Spell Attack feat<sup>CotS</sup>):** May add the effect of one sphere effect the cohort possesses that is compatible with Spell Attack to one creature that takes swarm damage. This does not provoke an attack of opportunity.
