...
- **Poisonous:** When the target makes a successful bite attack, it automatically attempts to poison its target (save Fort DC 10 + 1/2 Hit Dice + Constitution modifier; frequency 1/round for 6 rounds; effect 1d2 Con damage; cure 1 save).
