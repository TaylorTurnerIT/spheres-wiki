...
- **Hexcrafter:** The black magician gains a witch or shaman hex of her choice, treating her hedgewitch levels as witch/shaman levels and her casting ability modifier as her Intelligence/ Wisdom modifier when determining the effects. This does not grant access to major hexes or grand hexes. She may gain this secret multiple times. Each time it is taken, she gains an additional hex.
...
- **Expansive Dreamscape:** For each 10-foot cube of your dreamspace, you instead gain 4 10-foot cubes which you may arrange however you wish. [**Source:** Baron's Secluded Library]
- **Overnight Delivery:** If you have the dream travel grand secret, whenever you merge your dreamspace with the dream of another, you may transfer any items in your possession to a willing creature who you contacted in the dream, causing those items to appear around the dreamer when they wake up. [**Source:** Baron's Secluded Library]
...
At 13th level, this benefit lasts 1 hour.

At 17th level, the bonus applies to all saving throws.

__**Healing Concoction**__
The target is healed 1d6 hit points per 2 hedgewitch levels the herbalist possesses (minimum 1d6).

__**Herbalist's Poison**__
...
**Path Benefit**
Through her grief over the fallen, the lamenter has been bestowed an unnatural power through her voice. The lamenter gains the Banshee's Sotto Voce feat, even if she would not meet the prerequisites. If she already possesses the Banshee's Sotto Voce feat, she may immediately retrain that feat at no additional cost in money or time, selecting a new, valid feat or other choice for that feat (such as retraining a feat gained with level advancement to another valid feat). She may treat any of her lamentation path powers as sphere effects with the death descriptor for the purposes of the feat. When broadcasting her voice with this feat, the lamenter's voice can be heard clearly through solid obstacles such as walls, objects and other non magical effects that would block line of effect.

In addition to this, the lamenter gains a +2 bonus to saving throws against all sonic effects, language-dependent effects, and effects that would silence the lamenter. These bonuses increase by 1 at 5th level and every 5 levels thereafter. At 5th level, the lamenter also gains sonic resistance 5, which increases by 5 at 10th level and every 5 levels thereafter.

**Path Power**
**Wail (Su):** As a standard action, the lamenter can wail in a 15-foot cone, dealing damage to every creature within the cone. This deals 1d6 sonic damage + 1d6 damage at 5th level and every 5 hedgewitch levels thereafter. At 6th level, the lamenter may shape her wail into a 30-foot cone, increasing by 15 feet for every 6 levels thereafter. She may shape her wail smaller than her maximum size, but the wail must be measured in 15 feet increments. A lamenter may not wail if she is silenced by an effect that would silence her voice. All wails are sonic effects, and are still blocked by walls and other obstacles (unlike the lamenter's broadcasted voice).

**Miseries:** Miseries are additional effects which the lamenter may apply to her wails a number of times per day equal to 3 + 1/2 her hedgewitch level. Unless otherwise stated, the lamenter may only apply a single misery to each wail. Miseries that require a saving throw have a DC of 10 + 1/2 the hedgewitch's level + her casting ability modifier.

As the lamenter gains levels, she gains access to new forms of miseries. All lamenters know the following miseries.

- **Painful Misery:** At 1st level, the lamenter may cause her wail to additionally cause all creatures damaged by it to become sickened for a number of rounds equal to her hedgewitch level. A successful Fortitude save reduces the sickened condition to one round. This is a pain effect.
- **Powerful Misery:** At 1st level, the lamenter may enhance her wail to be particularly powerful. The wail deals 1d8 sonic damage, plus an additional 1d8 at 3rd level and every odd level thereafter. Creatures may attempt a Fortitude save to halve this damage. The lamenter may spend 1 spell point when using this misery to apply the effects of another misery with it. Combining this misery with another misery only consumes the use of a single misery.
- **Misery of the Lost Voice:** At 5th level, the lamenter may steal the voices of those she damages with her wail. Creatures damaged by her wail must succeed at a Fortitude save or be silenced for a number of rounds equal to the lamenter's hedgewitch level, and have their voice stolen by the lamenter. Stealing a creature's voice allows the lamenter to perfectly imitate their voice and any sounds the creature is capable of producing for the next 24 hours, as per the Vocal Mimicry trait of the Perfect Imitation talent of the Alteration sphere.
- **Frightening Misery:** At 9th level, the lamenter can modify her wail to cause all creatures damaged by it to be frightened for one round, and afterwards shaken for a number of rounds equal to her casting ability modifier. A successful Fortitude save negates the frightened condition, and reduces the shakened condition to one round. This is a fear effect.
- **Misery of Suffocation:** At 13th level, the lamenter may make a special, gasping wail. This wail deals no damage and makes no sound, but instead the lamenter channels her voice inward, stealing the breath of all creatures in a 60-foot radius and causing them to begin suffocating. The lamenter must spend a move action concentrating on this misery each round to maintain its effects, and she may not speak or perform another wail while concentrating on it. In addition to the normal suffocation rules, if a creature suffocating due to this wail suffers any amount of damage, they also reduce the number of rounds they can hold their breath before attempting Constitution checks by the lamenter's hedgewitch level. This wail is not a sonic effect. **Special:** While concentrating on this misery, the lamenter is considered to be holding their breath, and may hold their breath indefinitely as long as they have stolen the breath of at least one creature.
- **Banshee's Misery:** At 17th level, the lamenter may make her wail as a full-round action to activate her most powerful misery. This wail deals 10 damage per hedgewitch level in a 50-foot spread, rather than the normal range for her wail. A successful Fortitude save reduces this damage to 1d4 per hedgewitch level. After performing this wail, the lamenter is staggered for 1 round and her voice vanishes for 1d4 rounds, preventing her from speaking or making another wail until she regains her voice. This wail cannot be combined with any other misery, even if they normally can be combined with other wails. This is a death effect.

**Path Secrets**

- **Focused Wail:** When making a wail, you may instead have it only target a single creature within the range of your broadcasted voice. You must have line of sight to the creature to target them. Doing so also increases the damage dealt by the wail by 1 for every 2 hedgewitch levels, increased to 1 per hedgewitch level if the wail is enhanced by a misery. If you can utilize the benefit of the Banshee's Sotto Voce gained when you possess at least 4 Necrosis feats, you may select any amount of creatures within your broadcasted voice when you speak to hear your words; other creatures cannot overhear your words. You do not need line of sight to target a creature, but you must know their exact location to speak to them through solid obstacles or walls.
- **Forceful Wail:** When making a wail, you may choose for the wail to deal minimum damage. If you do so, creatures that would be affected by the wail must attempt a Reflex save or be knocked back directly away from the origin of the wail for a distance equal to 5 feet for each point of damage the wail deals to the creature. If a creature would collide with another creature, wall or other obstacle, they suffer 1d4 bludgeoning damage per 5 feet of distance they would have travelled beyond the obstacle and are knocked prone. Half of this damage is also dealt to the creature or object they collided with. A creature may only be damaged once by this ability per use. This ability cannot be combined with the banshee's misery wail.
- **Haunting Voice:** Creatures suffering from a fear effect take an additional -2 penalty to saving throws made against your wail. This penalty increases by 1 at 10th level and every 10 levels thereafter.
- **Safe Wail:** When performing a wail modified by a misery, you may select a number of creatures equal to your casting ability modifier that you can see. These creatures are not affected by your wail.
- **Shaped Wail:** The lamenter may shape her wail into odd forms. She may shape her wail into a 30-foot line, or a 10-foot burst. These ranges increase by 30 feet and 10 feet respectively for every 6 hedgewitch levels, and she may choose to shape her wail into smaller ranges as long as they are measured in segments of 30 feet for lines, or 10 feet for bursts. Additionally, you are treated as if you possessed three additional Necrosis feats, but only for the purposes of the Banshee's Sotto Voce feat.
- **Shatterer of Silence:** The lamenter may spend 1 spell point to attempt to wail even if she is otherwise silenced, or when she attempts to wail into a silenced region. She must attempt a magical skill check against the source of the silencing effect (for effects without a magic skill defense, resolve this check against a DC of 11 + the source effect's CR). If she succeeds at this check, the silencing effect is dispelled or otherwise ended, and the lamenter's wail functions as normal.
- **Voice of Thunder:** As a move action, the lamenter may speak a single word. All creatures within the range of her broadcasted voice must attempt a Fortitude save, as if against one of her miseries, or become deafened for 1d4 rounds. A creature deafened by this ability may not suffer from it again for one hour. If you possess the safe wail or the focused wail secrets, you may apply their effects to this secret as if it were a wail.

**Path Grand Secrets**

- **Infectious Fright:** When a creature suffering from a fear effect fails a save against a wail modified by one of your miseries, they instinctively scream out, causing them to extend the range of your wail. A new area of effect using the same shape and range as the original wail extends out from their position, in any direction you desire. This new area of effect is considered to be part of the original wail, meaning that creatures that have already suffered from this instance of the wail cannot suffer from it again. This scream automatically gives away the creature's position, and foils their stealth. This may cause multiple creatures to chain together and scream, as long as they were suffering from a fear effect.
- **Last Breath:** When making a wail, you may spend 1 additional spell point to drain the life of creatures that would be slain by it. If the wail would reduce a creature to 0 or fewer hit points, or strikes a creature that is currently dying, the creature must succeed at a Fortitude save or else be slain. Creatures slain by the wail (whether by hit point damage or a failed save) ability have their breath stolen as per the misery of suffocation, and you regain a use of your misery for each creature with Hit Dice equal to or greater than half your hedgewitch levels that fails their Fortitude save. This is a death effect. **Special:** If you possess the Necrotic Feeding (ghost strike) talent from the Death sphere, you may spend 1 additional spell point when using this grand secret to gain its benefits for each creature that fails the Fortitude save from this ability.
- **Omnipresent Voice (requires shaped wail):** Your broadcasting voice increases to extreme range (1,000 feet + 100 per hedgewitch level).
- **Spirits's Jaunt:** After making a wail modified by a misery, the lamenter may spend 1 spell point as a free action to cause herself to become ethereal until the end of her turn. While ethereal, she is invisible and insubstantial, and is capable of moving in any direction, even up and down. As an insubstantial creature, she can move through solid objects, even living creatures. If she ends her turn while inside a material object (such as a solid wall), she is shunted off to the nearest open space and takes 1d6 points of damage per 5 feet that she so travels.
- **Wailing Woman:** When a creature within the range of your wail would be slain by a death effect or hit point damage, you may spend 1 spell point as an immediate action to wail in response to their oncoming death. This wail only affects the source of the death effect or hit point damage, and resolves before the damage or effect. This may stop the effect or damage from taking place (for example, by causing the source creature to be frightened and unable to attack or by killing them).
...
**Class Skills:** Disable Device (Dex), Disguise (Cha), Knowledge (engineering) (Int)
    
**Path Benefits:** The technomancer gains either the Technomancy Sphere or the Tinker sphere as a bonus talent.
    
**Path Power:**  The technomancer can channel either positive or negative energy (chosen when she uses this ability) a number of times per day equal to 3 + her casting ability modifier. When a technomancer channels energy to heal or harm living creatures, she instead heals or harms constructs with the clockwork or robot subtypes. Constructs without those subtypes are also affected, but gain only half the normal amount of healing or take only half the normal amount of damage, as appropriate. The technomancer can take other feats to add to this ability, such as Extra Channel and Improved Channel, but not feats that alter this ability, such as Elemental Channel and Alignment Channel. The DC to save against this channeled energy is equal to 10 + 1/2 the technomancer's level + the technomancer's casting ability modifier. 

**Path Secrets:** A hedgewitch with the technomancy path adds the following secrets to those she may select:

- **Applied Learning (Ex):** When a technomancer succeeds at a saving throw against a technological effect that has reduced effects on a successful save, she instead avoids the effect entirely. A helpless or flat-footed technomancer does not benefit from this ability. 

- **Enforce Reliability (Su):** As a free action, the technomancer may spend a spell point to prevent a piece of technological equipment they are holding from glitching for 1 round.

- **Recondition {Su):** Through constant maintenance, a technomancer can keep a single piece of still-functioning timeworn technology in good working order. Reconditioning a timeworn technological item takes 8 hours, after which the item no longer has a chance of glitching when used by the technomancer and can be recharged normally by the technomancer but no one else. Keeping the item working requires 1 hour of maintenance each day, or the item reverts to a normal piece of timeworn technology and must be reconditioned again. At 4th level and every 3 levels thereafter, a technomancer can keep an additional item in good working order, without increasing her daily maintenance time.

- **Study Technology (Ex):** a technomancer can study a construct, technological object, or technological trap within 30 feet as a move action and attempt a Knowledge (engineering) check to identify it. If she succeeds, she gains a +1 competence bonus on attack rolls, combat maneuver checks, saving throws, and skill checks involving the studied creature, object, or trap, as well as a dodge bonus of the same amount against attacks from the subject of her study. This bonus lasts a number of rounds equal to her casting ability modifier (minimum 1) and increases by 1 at 5th level and every 4 hedgewitch levels thereafter. If the technomancer studies a new subject, she loses her bonus against the previous subject. 

**Path Grand Secrets:** A hedgewitch with the technomancy path adds the following grand secrets to those she may select:

- **Glitch Mastery (Su):** whenever a technomancer triggers a glitch when using a timeworn technological item, she rolls twice and can choose which of the two glitch effects actually occurs. A technomancer always adds her level to rolls to determine what kind of glitch occurs, and treats rolls of over 100 as 100.

- **Unified Energy (Su):** As part of using an ability that would require the expenditure of spell points, the technomancer may substitute charges from a technological item she is holding for spell points at a rate of 5 charges per spell point. 
...
**Path Power:** The tempest-tost's mood and power is volatile, changing like the weather she draws power from. She is in one of 3 states at any given time. She has no control over what state she is in: when she wakes up after an 8 hour rest, she chooses her state at random (such as by rolling 1d3), and whenever she is hit with an attack that is a natural 20, fails a saving throw, or regains consciousness, her state randomly (such as by rolling 1d2 or flipping a coin) changes to one of the other two states.
...
**Alraun:** +1/5 of a secret from the charlatanism path. You must possess the charlatanism path or the amateur hedgewitch secret to benefit from this option. 

**Cecaelia:** +1/4 CL with the (water) package of the Nature sphere. This stacks normally with caster levels gained from other sources.
...
**Kobold:** +1/5 of a secret from the charlatanism path. You must possess the charlatanism path or the amateur hedgewitch secret to benefit from this option.

**Leshy:** +1/5 of a secret from the herbology path. You must possess the herbology path or the amateur hedgewitch secret to benefit from this option.
...
**Skinwalker:** +1/5 of a secret from the green magic path. You must possess the green magic path or the amateur hedgewitch secret to benefit from this option.
