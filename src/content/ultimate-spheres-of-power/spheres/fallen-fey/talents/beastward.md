...
**Repel Beast:** Creatures of the animal type will not approach closer to you than than 30 feet unless compelled to do so by a Handle Animal check or a compulsion effect. Creatures of the animal type within this range are shaken as long as they remain within it. This does not apply to animal allies such as animal companions, summoned creatures of the animal type, or creatures that are tame per the Beastmastery sphere (see Spheres of Might).

**Repel Vermin:** Creatures of the vermin type will not approach closer to you than than 30 feet unless compelled to do so by a Handle Animal check or a compulsion effect. Creatures of the vermin type within this range are shaken as long as they remain within it. This ignores the immunity to the shaken condition granted by the vermin type. This does not apply to vermin under your control such as vermin companions, summoned vermin, or creatures that are tame per the Beastmastery sphere (see Spheres of Might).
