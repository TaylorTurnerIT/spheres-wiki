...
*On Spell Point Damage:* Spell point damage adds a new dynamic to a game that uses the Spheres of Power system of magic. It's important to note that these abilities were created with a player-use case primarily, and that they are balanced around the notion that a player will encounter enemies who often have their spell point capacity filled up. Due to this, all GMs should take extra caution when utilizing any abilities that deal spell point damage on players.
