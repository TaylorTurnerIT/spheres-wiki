...
Orb creatures are lantern archons, will-o-wisps, gibbering orbs, and other mystical fey, outsiders, constructs, or aberrations with a floating sphere-like appearance and supernatural movement. An orb lacks any limbs, but may treat its body as a head for the purpose of adding natural attacks. An orb companion may not be tripped unless gaining legs from another source.
 ...
 The Skillful Companion (form) talent increases Int to 13 if taken.
**Quadruped**
...
Your companion reduces one of its speeds by 20 feet and gains a 20 feet swim speed. Companions with a base form that grants a speed of less than 20 feet are not eligible for this archetype. If this companion later gains the Water Being (form) talent, increase the swim speed granted by that talent by +10 feet.
...
A guileful companion loses either the evasion, devotion, multiattack, and improved evasion special abilities or all natural attacks granted by its base form, and may exchange them both to also gain either the Sage Companion or Skillful Companion talent.
