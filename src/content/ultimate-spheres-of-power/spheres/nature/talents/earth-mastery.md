...
**Author's Note:** When Sandstone states that it uses the Bury geomancing DC, it is primarily referring to the +1 DC increase for each subsequent round in which a target does not escape from the effect while it is still active.
