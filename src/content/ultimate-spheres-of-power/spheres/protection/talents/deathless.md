...
**Author's Note:** The Deathless aegis only grants a save to negate one of the listed effects if no save was already offered by that effect. This Will save is at the ability's normal DC, and if one is unlisted, the GM should determine what the DC of that ability is (usually 10+1/2 the source's Hit Dice+a relevant ability score modifier).
