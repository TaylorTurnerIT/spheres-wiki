...
New to The Gravecaller's Handbook is an update and errata to a number of talents that previously used or interacted with the Master's Presence talent. This change standardizes the range of these talents to close range and taking the Ranged Death talent can increase this range.
