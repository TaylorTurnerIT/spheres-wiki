...
When attempting to break an object that does not have a predetermined Break DC, the Break DC is equal to 10 + the object's hardness +1 per inch in the item's thickness.
...
| Object Size | Min. Caster Level | Example Objects | Max. Weight (lbs.) | Falling Damage |
| --- | --- | --- | --- | --- |
