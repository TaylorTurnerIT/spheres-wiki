...
At 10th level, the void conduit gains a unique sense, allowing the void conduit to always know the distance and direction of any portals, rifts (including extradimensional spaces), teleportation circles, and other means of planar transportation (such as fairy rings or ley lines), as though under a constant Divination sphere divine effect for the Divine Warp alternate divination. Use the void conduit's Divination sphere caster level to determine this sense's range and effects. This sense is blocked by effects which would block or ward against divination effects. If the void conduit possesses abilities that would improve their Divination sphere divine sphere effect, this sense is also improved (i.e. Divination sphere Greater Range).
