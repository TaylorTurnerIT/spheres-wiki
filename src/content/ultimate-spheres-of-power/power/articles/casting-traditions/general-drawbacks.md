---
id: general-drawbacks
name: "General Drawbacks"
type: "article"
---

## {.toc-include} Drawbacks
...
##### {.toc-include} Bonded Casting [3PP]
<div class="source-tag">Source: Baron’s Glorious Arena</div>
...
##### {.toc-include} Burdened Magic [Archmagi's HB]
...
##### {.toc-include} Card Casting [3PP]
<div class="source-tag">Source: Expanded Spheres: Cardcaster's Gamble</div>
...
<div class="source-tag">Source: Baron’s Secluded Library</div>
...
###### {.toc-include} Creating and Using a Deck
...
##### {.toc-include} Catastrophic Failure [3PP]
...
<div class="source-tag">Source: Card Casting 3: Volatile Variance</div>

##### {.toc-include} Center Of Power
...
##### {.toc-include} Charged Spells [Apoc]
...
##### {.toc-include} Clarke Compliance [SUE]
...
Your magic sphere effects are treated as both magical and mechanical for effects, whichever is more disadvantageous (such as for being countered, disabled, disrupted, resisted, or suppressed by abilities and effects that would interact with a magic or mechanical effect). Treat the gizmo level of your magic sphere effects as being equal to your magic skill bonus for the purposes of effects that depend on gizmo level.
...
##### {.toc-include} Consciousness Linked
...
##### {.toc-include} Decrepit Casting [CrimDan]
...
##### {.toc-include} Dedicated Wright [3PP]
<div class="source-tag">Source: Baron’s Glorious Arena</div>
...
##### {.toc-include} Dreamlost Casting [SM—]
<div class="source-tag">Source: Baron's Otherworldly Citadel</div>
...
##### {.toc-include} Expensive Locus [Apoc]
<div class="source-tag">Source: [Spheres Apocrypha: Casting Traditions](https://www.drivethrurpg.com/product/286411/Spheres-Apocrypha-Casting-Traditions?affiliate_id=549120)</div>
...
##### {.toc-include} Incompatible Energies [S&P]
...
##### {.toc-include} Madness Mantra [Apoc]
<div class="source-tag">Source: [Spheres Apocrypha: Casting Traditions](https://www.drivethrurpg.com/product/286411/Spheres-Apocrypha-Casting-Traditions?affiliate_id=549120)</div>
...
##### {.toc-include} Madness Mantra, Variant [SM—]
<div class="source-tag">Source: Baron’s Uncanny Gateway</div>
...
##### {.toc-include} Narcoleptic Casting
...
##### {.toc-include} Oathbound Casting [DbH]
...
#### {.toc-include} Planebound Magic [LG]
...
##### {.toc-include} Ramp Up [3PP]
<div class="source-tag">Source: Card Casting 2: Counters and Control</div>
...
##### {.toc-include} Restricted Channels [LG]
<div class="source-tag">Source: Arcforge Players Compendium</div>
...
##### {.toc-include} Rigorous Concentration
...
##### {.toc-include} Spell Stand-In [Apoc]
...
##### {.toc-include} Substantial Magic [EO3]
...
##### {.toc-include} Technical Caster [3PP]
<div class="source-tag">Source: Baron’s Glorious Arena</div>
...
##### {.toc-include} Unreliable Training [3PP]
<div class="source-tag">Source: Baron’s Glorious Arena</div>
...
##### {.toc-include} Unsettling Casting [Cata. HB]
...
##### {.toc-include} Unstable Storage [Mana HB]
...
##### {.toc-include} Vampiric Casting [CrimDan]
...
##### {.toc-include} Vulnerable Spellcaster [Mana HB]
