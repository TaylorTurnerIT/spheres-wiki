---
id: sphere-drawbacks
name: "Sphere-Specific Drawbacks"
type: "article"
---

### {.toc-include} Sphere-Specific Drawbacks
...
#### {.toc-include} Universal
##### {.toc-include} Striker [3PP]
...
#### {.toc-include} [Alteration](@sphere:alteration)
##### {.toc-include} Beast Soul
...
##### {.toc-include} Transformative Brew
...
##### {.toc-include} Unnatural Transformation
...
#### {.toc-include} [Blood](@sphere:blood)
##### {.toc-include} Cruoromancy [BaP]
...
##### {.toc-include} Limited Acceleration
...
#### {.toc-include} [Conjuration](@sphere:conjuration)
##### {.toc-include} Caller
...
##### {.toc-include} Life Merger [Alienist HB]
...
##### {.toc-include} Limited Range [Apoc]
<div class="source-tag">Source: [Spheres Apocrypha: Cohorts & Companions](https://www.drivethrurpg.com/product/297259/Spheres-Apocrypha-Cohorts-and-Companions?affiliate_id=549120)</div>
...
#### {.toc-include} [Creation](@sphere:creation)
##### {.toc-include} Counterfeit [DbH]
...
##### {.toc-include} Down To Earth [Apoc]
<div class="source-tag">Source: [Spheres Apocrypha: Casting Traditions](https://www.drivethrurpg.com/product/286411/Spheres-Apocrypha-Casting-Traditions?affiliate_id=549120)</div>
...
#### {.toc-include} [Dark](@sphere:dark)
##### {.toc-include} Black Spot
...
##### {.toc-include} Shadow Aura [Alienist HB]
...
#### {.toc-include} [Death](@sphere:death)
##### {.toc-include} Death To The Living
...
##### {.toc-include} Necromantic Concoction
...
##### {.toc-include} Spiritual Voyager [DbH]
...
#### {.toc-include} [Destruction](@sphere:destruction)
##### {.toc-include} Aligned Combatant
...
##### {.toc-include} Uncontrolled Blaster [Alienist HB]
...
#### {.toc-include} [Divination](@sphere:divination)
##### {.toc-include} Divining Concoction
...
#### {.toc-include} [Enhancement](@sphere:enhancement)
##### {.toc-include} Bodily Enhancement
...
##### {.toc-include} Marking Enhancements
...
##### {.toc-include} Power Leech [Alienist HB]
...
#### {.toc-include} [Fallen Fey](@sphere:fallen-fey)
##### {.toc-include} Terrain-Bonded [BaP]
...
#### {.toc-include} [Fate](@sphere:fate)
##### {.toc-include} Cursed Brew
...
##### {.toc-include} Non-Judgemental [DbH]
...
##### {.toc-include} Sanctified
You may not create words.

**Incompatible:** Neutrality

##### {.toc-include} Tongue Of Ages
You may not create consecrations.

**Incompatible:** Luckless

#### {.toc-include} [Illusion](@sphere:illusion)
##### {.toc-include} Disappearance
...
#### {.toc-include} [Life](@sphere:life)
##### {.toc-include} Fueled by Futility [Alienist HB]
...
##### {.toc-include} Limited Restoration
...
#### {.toc-include} [Light](@sphere:light)
##### {.toc-include} Flexible Lens
...
#### {.toc-include} [Mana](@sphere:mana)
##### {.toc-include} Conservationist [Mana HB]
...
##### {.toc-include} Incongruent [Mana HB]
...
##### {.toc-include} Selfish Caster [Mana HB]
...
##### {.toc-include} Weapon-bound [Mana HB]
...
#### {.toc-include} [Mind](@sphere:mind)
##### {.toc-include} Addling Brew
...
##### {.toc-include} Blatant Side-Effects
...
##### {.toc-include} Inward Focus [Apoc]
<div class="source-tag">Source: [Spheres Apocrypha: Cognition Talents](https://www.drivethrurpg.com/product/293022/Spheres-Apocrypha-Cognition-Talents?affiliate_id=549120)</div>
...
##### {.toc-include} Lost In Translation
...
##### {.toc-include} Unusual Entreatment [3PP]  
<div class="source-tag">Source: Expanded Spheres: Baron's Lost Apocrypha</div>
...
#### {.toc-include} [Nature](@sphere:nature)
##### {.toc-include} Holistic Brew
...
<div class="wiki-note">**Wiki Note:** This means you don't have a base geomancing package.</div>

#### {.toc-include} [Protection](@sphere:protection)
##### {.toc-include} Alternate Aegis
...
##### {.toc-include} Aligned Protection
...
#### {.toc-include} [Telekinesis](@sphere:telekinesis)
##### {.toc-include} Directional Control
...
##### {.toc-include} Limited Telekinesis
...
##### {.toc-include} Passive Telekinesis
...
#### {.toc-include} [War](@sphere:war)
##### {.toc-include} Alternate Rally
...
##### {.toc-include} Battle Manipulation
...
##### {.toc-include} Exploitable Momentum [SM—]
<div class="source-tag">Source: Baron’s Uncanny Gateway</div>
...
##### {.toc-include} Manifest Totem [Alienist HB]
...
##### {.toc-include} Small Unit Strategist
...
##### {.toc-include} Distorting Presence [DbH]
...
##### {.toc-include} Exploit Fragility [SM—]
<div class="source-tag">Source: Baron’s Uncanny Gateway</div>
...
##### {.toc-include} Inanimate Teleport
...
##### {.toc-include} Splintering Teleport
...
#### {.toc-include} [Weather](@sphere:weather)
##### {.toc-include} Atmospheric Brew
...
---
## {.toc-include} Dual Sphere Drawbacks [3PP]
<div class="source-tag">Source: Expanded Spheres: Baron's Lost Apocrypha</div>
...
##### {.toc-include} Admixture Specialist
...
##### {.toc-include} Approximate Manabond
...
##### {.toc-include} Elemental Specialization
...
##### {.toc-include} Lethal Enhancements
...
##### {.toc-include} Medical Evacuation
...
##### {.toc-include} Unstable Creations
**Associated Sphere:** Creation
