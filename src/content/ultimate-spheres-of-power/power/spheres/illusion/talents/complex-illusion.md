...
When creating glamers, you may spend an additional spell point to affect multiple different targets with the same glamer so long as they are all within your illusion range and the combined size of affected targets does not exceed your maximum illusion size. For example, if your maximum illusion size is Large, you could affect with this talent 2 Medium-sized targets or 4 Small-sized targets with your glamer. Once created, each glamer is considered a separate sphere effect.
