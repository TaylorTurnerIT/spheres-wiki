...
active: true
iteration: 1
session_id: 8756401e-c9a9-4715-99e6-fadb79d15cae
max_iterations: 20
completion_promise: "CAVEKIT COMPLETE"
started_at: "2026-06-12T14:39:05Z"
---
...
2. `context/plans/build-site-dedup.md` — the task dependency graph
3. Impl tracking files in `context/impl/` — but ONLY files that are scoped to this build site.
   An impl file is scoped if it contains `Build site: context/plans/build-site-dedup.md` (or the matching basename).
...
- `context/kits/cavekit-content-conversion.md`
- `context/kits/cavekit-courser-class-entry.md`
- `context/kits/cavekit-courser-class-features.md`
- `context/kits/cavekit-courser-core-ventures.md`
- `context/kits/cavekit-courser-drs-content.md`
- `context/kits/cavekit-dedup-components.md`
- `context/kits/cavekit-dedup-overview.md`
- `context/kits/cavekit-dedup-routes.md`
- `context/kits/cavekit-guile-conversion.md`
- `context/kits/cavekit-guile-resume-prompt.md`
- `context/kits/cavekit-overview.md`
- `context/kits/cavekit-venator-archetype.md`
false_SECTION
## Each Iteration
